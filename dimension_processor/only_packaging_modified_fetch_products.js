...
try {
  ...
  fs.writeFileSync('only_packaging_strict_products_output_dimensions.csv', csvHeader + csvRows.join('\n'), 'utf8');
  console.log(`CSV saved as only_packaging_strict_products_output_dimensions.csv (${results.length} rows)`);
} catch (err) {
